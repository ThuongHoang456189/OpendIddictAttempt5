...
namespace OpendIddictAttempt4.Web.Menus;

public class OpendIddictAttempt4MenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public OpendIddictAttempt4MenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<OpendIddictAttempt4Resource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                OpendIddictAttempt4Menus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
